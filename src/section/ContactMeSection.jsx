...
import { FaEnvelope, FaPhoneAlt, FaMapMarkerAlt, FaCopy, FaTelegramPlane  } from "react-icons/fa";
import { RiGithubFill, RiLinkedinBoxFill, RiTwitterXFill, RiInstagramLine, RiWhatsappFill , RiLinkedinFill, Ri24HoursLine , RiPlaneFill} from "react-icons/ri";
...
import PlatformLogo from "../components/ui/platformLogo";
 ...
 const ContactSection = () => {
  ...
  return (
    <section className="flex flex-col lg:flex-row  h-fit">
{/* {Right Section} */}
    <div className="px-10 py-6 flex flex-col  gap-7 lg:max-w-1/2 w-full">
       
       <ContentCard capsuleData={"Get in Touch"} 
        description={<span className="leading-3.5">Have a Project in mind to say hi? <br /> I would Like to hear from you . Fill out the form or reach me directly through any of the channels below . </span>}
  ...
  <div className="flex flex-col gap-3 w-full">
    ...
    <ChannelCard Icon={<FaEnvelope color="black" size={22}/>}
                 ChannelName={"Email"}
    ...
    />
     ...
     <ChannelCard Icon={<FaPhoneAlt color="black" size={22}/>}
                 ChannelName={"Phone"}
    ...
    />
     ...
     <ChannelCard Icon={<FaMapMarkerAlt color="black" size={22}/>}
...
<h1>Connect with me</h1>
 ...
 <PlatformLogo Logo={<RiGithubFill size={28}/>}/>
 <PlatformLogo Logo={<RiInstagramLine size={28} color={"purple"} /> }/>
 <PlatformLogo Logo={<RiLinkedinBoxFill size={28} color="blue" />}/>
 <PlatformLogo Logo={<RiWhatsappFill size={28} color="green"/>}/>
 <PlatformLogo Logo={<Ri24HoursLine size={28}/>}/>
  ...
  <div className="flex flex-col gap-6 w-full">
    ...
    <div className="flex items-center gap-3 border-b border-gray-100 pb-4">
      <PlatformLogo Logo={<FaTelegramPlane size={24} className="text-purple-700" />} />
      <h3 className="text-lg font-bold text-gray-800">Send me a Message</h3>
    </div>
